import { TextItem, FeatureSet, ResumeSectionToLines } from "../types";
import { isBold, hasLetterAndIsAllUpperCase, hasNumber, hasComma, hasLetter } from "./lib/common-features";
