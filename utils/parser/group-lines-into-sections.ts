...
import { isBold, hasLetterAndIsAllUpperCase, hasOnlyLettersSpacesAmpersands } from "./extract-resume-from-sections/lib/common-features";
import { Lines, ResumeSectionToLines, Line } from "./types";
